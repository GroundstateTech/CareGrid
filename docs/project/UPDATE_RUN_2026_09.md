...
This branch is the reviewable stability-and-feature pass for **CareGrid** (Python/Tkinter clinical prototype). It intentionally excludes user databases, credentials, private inventory, generated caches, and machine-local configuration.

## Priority checks

- normalization and datastore safety
- adapter failure isolation
- patient/alert regression coverage
